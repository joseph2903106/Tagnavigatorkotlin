...
import com.tagnavigatorkotlin.child.MyListMainChildFragment

/**
 * Created by josephwang on 2017/5/8.
 */

class MyListMainFragment : JParentFragment<MainActivity>() {
    @BindView(R.id.back)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        status.text = TAG
        status.setOnClickListener { commitChildFragment(MyListMainChildFragment()) }
        return content
    }
